...
sudo apt install -y libfuse2 libykpers-1-1 libyubikey-udev software-properties-common apt-transport-https wget htop npm timemachine steam libapr1 libaprutil1t64 libasound2t64 libglib2.0-0t64 libxcb-cursor0
